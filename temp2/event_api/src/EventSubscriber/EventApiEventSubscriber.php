...
namespace Drupal\event_api\EventSubscriber;
 ...
 */
class EventApiEventSubscriber implements EventSubscriberInterface {
  ...
  public static function getSubscribedEvents() : array {
    $events[KernelEvents::VIEW][] = ['check', 10];
    return $events;
  }
  ...
  public function check(ViewEvent $event) {
    ...
    $this->routeMatch->getParameter('node')->getType() === 'movie_details') {
